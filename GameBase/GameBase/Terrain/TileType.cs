...
namespace GameBase.Terrain
{
    public class TileType
    {
        ...
        public static TileType WALL_HORIZONTAL = new TileType(80, 32, 32, new Vector2(32.0f, 64.0f), false);
        public static TileType WALL_TOP_TO_LEFT = new TileType(80, 32, 32, new Vector2(0.0f, 96.0f), false);
        public static TileType WALL_TOP_TO_RIGHT = new TileType(80, 32, 32, new Vector2(32.0f, 96.0f), false);
        public static TileType WALL_RIGHT_TO_BOTTOM = new TileType(80, 32, 32, new Vector2(64.0f, 96.0f), false);
        public static TileType WALL_LEFT_TO_BOTTOM = new TileType(80, 32, 32, new Vector2(96.0f, 96.0f), false);
        public static TileType WALL_VERTICAL_WITH_LEFT = new TileType(80, 32, 32, new Vector2(0.0f, 128.0f), false);
        public static TileType WALL_VERTICAL_WITH_RIGHT = new TileType(80, 32, 32, new Vector2(32.0f, 128.0f), false);
        public static TileType WALL_HORIZONTAL_WITH_BOTTOM = new TileType(80, 32, 32, new Vector2(64.0f, 128.0f), false);
        public static TileType WALL_HORIZONTAL_WITH_TOP = new TileType(80, 32, 32, new Vector2(96.0f, 128.0f), false);
        public static TileType WALL_ALL_FOUR = new TileType(80, 32, 32, new Vector2(0.0f, 160.0f), false);
